        ...
        return(
            ...
            <div className="top-left">
                <div className="navbar-header">
                    <a className="navbar-brand" href="./"><img src="assets/images/logo.png" alt="Logo"></img></a>
                    <a className="navbar-brand hidden" href="./"><img src="assets/images/logo2.png" alt="Logo"></img></a>
                ...
                <div className="header-menu">
                    <div className="header-left">
                        ...
                        <div className="dropdown for-message">
                            ...
                            <div className="dropdown-menu" aria-labelledby="message">
                                ...
                                <a className="dropdown-item media" href="#">
                                    <span className="photo media-left"><img alt="avatar" src="assets/images/avatar/1.jpg"></img></span>
                                ...
                                <a className="dropdown-item media" href="#">
                                    <span className="photo media-left"><img alt="avatar" src="assets/images/avatar/2.jpg"></img></span>
                                    <div className="message media-body">
                                ...
                                <a className="dropdown-item media" href="#">
                                    <span className="photo media-left"><img alt="avatar" src="assets/images/avatar/3.jpg"></img></span>
                                    <div className="message media-body">
                                ...
                                <a className="dropdown-item media" href="#">
                                    <span className="photo media-left"><img alt="avatar" src="assets/images/avatar/4.jpg"></img></span>
                                    <div className="message media-body">
                    ...
                    <div className="user-area dropdown float-right">
                        <a href="#" className="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img className="user-avatar rounded-circle" src="assets/images/admin.jpg" alt="User Avatar"></img>
                        </a>
